...
export const companiesData: CompanyData[] = [
  {
    slug: "bcc",
    name: "Business Coaching Club",
    description: "An annual mentorship and business networking ecosystem designed to help entrepreneurs structure scalable growth, build sustainable brands, and protect their long-term legacy.",
    aboutParagraphs: [
  ...
  {
    slug: "youth_immersion",
    name: "Youth Immersion",
    description: "A transformative immersion program for young adults focused on purpose-discovery, personal growth, and preparing for the future with clarity and confidence.",
  ...
  },
  {
    slug: "deep_immersion",
    name: "Deep Immersion",
    description: "Embark on a seven-day journey of self-discovery, utilizing innovative coaching, holistic healing, and NLP techniques to transform various facets of your life.",
  ...
  {
    slug: "business_immersion",
    name: "Business Immersion",
    description: "A seven-day residential program exclusively designed for business owners and leaders, focusing on productivity, leadership skills, and developing the next generation of leaders.",
  ...
  },
  {
    ...
    description: "The most sought-after, innovative, ethical, and result-oriented coaching, counselling, and training & development offerings in the Middle East since 2010, now expanded to India.",
  ...
  {
    slug: "teens_immersion",
    name: "Teens Immersion",
    description: "Teen Immersion offers a transformative experience for teenagers aged 14 to 19, providing a platform for self-discovery and growth. Through a blend of adventure, creativity, and mindfulness practices, participants explore their potential, develop resilience, and clarify their life vision.",
