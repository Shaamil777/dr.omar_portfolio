  ...
  return (
    ...
    >
      <div ref={textWrapperRef} className="relative z-0 px-2 md:px-0 flex flex-col justify-center h-full w-full">
        {/* Base Dim Text */}
        <h1
          className="relative z-0 text-[22vw] sm:text-[18vw] md:text-[14vw] pt-[1vw] leading-[0.85] md:leading-[0.75] font-black uppercase text-center tracking-tight pointer-events-none select-none transition-opacity duration-300 scale-y-[1.4] md:scale-y-100 bg-[length:10px_10px] md:bg-[length:24px_24px]"
          style={{
